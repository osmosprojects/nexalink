...
exports.runMatchmakingPrecomputation = runMatchmakingPrecomputation;
exports.initMatchmakingCron = initMatchmakingCron;
const db_1 = require("../config/db");
const matchScoring_1 = require("../services/matchScoring");
let cron = null;
try {
...
async function runMatchmakingPrecomputation() {
    ...
    try {
        ...
        const profiles = await (0, db_1.query)(`
    ...
    `);
        ...
        for (let i = 0; i < totalUsers; i++) {
            ...
            for (let j = 0; j < totalUsers; j++) {
                ...
                const matchAtoB = (0, matchScoring_1.calculateMatchScore)(userA, userB);
        ...
        for (let i = 0; i < allRecords.length; i += BATCH_SIZE) {
            ...
            for (const rec of batch) {
                await (0, db_1.query)(`INSERT INTO match_scores (userA_id, userB_id, score, reasons, computed_at)
           VALUES (?, ?, ?, ?, NOW())
           ON DUPLICATE KEY UPDATE
             score = VALUES(score),
             reasons = VALUES(reasons),
             computed_at = NOW()`, [rec.userA_id, rec.userB_id, rec.score, JSON.stringify(rec.reasons)]);
            }
        }
